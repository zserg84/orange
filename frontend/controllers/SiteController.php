...
class SiteController extends Controller
{
    ...
    {
        $this->view->params['startPage'] = true;
        $mainImages = MainGallery::find()->all();
    ...
    public function actionTenants(){
        $orange = OrangeProperty::find()->one();
        $orange = $orange ? $orange : new OrangeProperty();

        $advertisings = Advertising::find()->all();

        $freeSpaces = Space::find()->free()->all();
